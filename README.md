...
5. Make the `value` property on the storage.Item an interface that has to implement proto Unmarshaler and Marshaler that way you can use w/e struct you want as long as it implements the interface. We **may** need to do Gob stuff as well.
